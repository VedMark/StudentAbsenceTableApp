    ...
    : QDialog(parent)
{
    ...
    resultTable = new StudentTableView(this);
...
void FindDialog::displayStudentEntryList(const QList<StudentEntry> &list)
{
...
void FindDialog::configStackedWidget()
{
...
void FindDialog::connectLineEdits()
{
...
void FindDialog::addEffect(QWidget *widget)
{
...
bool FindDialog::isName(const QString& text) const
{
